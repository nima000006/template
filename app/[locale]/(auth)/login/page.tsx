  ...
  return (
    <div className="space-y-6">
      ...
      <form className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link href={`/${l}/forgot-password`} className="text-xs text-primary hover:underline">{l === "fa" ? "فراموشی رمز عبور؟" : "Forgot password?"}</Link>
          </div>
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link href={`/${l}/register`} className="text-primary font-medium hover:underline">{l === "fa" ? "ثبت‌نام کنید" : "Sign up"}</Link>
      </p>
    </div>
  );
}
